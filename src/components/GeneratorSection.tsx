...
import { Sparkles, Wand2, Loader2, AlertCircle, RefreshCw, Download, Scissors, Share2 } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div className="relative group">
            ...
            />
            <div className="absolute bottom-4 right-4 text-[10px] font-mono text-neutral-600 uppercase tracking-widest">
              Prompt Engineering
            </div>
          </div>
                  ...
                  <button 
                    onClick={() => {
                      if (navigator.share) {
                        navigator.share({
                          title: 'Anime Fusion',
                          text: `Check out this anime fusion: ${generatedImage.prompt}`,
                          url: window.location.href
                        });
                      }
                    }}
                    className="p-3 bg-indigo-600 hover:bg-indigo-500 rounded-xl transition-colors flex items-center gap-2 text-xs font-bold"
                  >
